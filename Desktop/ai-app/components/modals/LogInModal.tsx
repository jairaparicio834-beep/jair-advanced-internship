...
const LogInModal = ({ setModal }: LogInModalProps) => {
        ...
        <>
            ...
            <Modal open={isOpen} onClose={() => dispatch(closeModal())}
                ...
                <div className='bg-white w-full max-w-[400px] outline-none h-[640px] p-[32px] relative rounded-md flex flex-col '>
                    ...
                    <h3 className='font-bold text-[32px] text-[#1f2328] mb-[20px] font-weight-800 text-center'>Log in </h3>
                    {error &&
                        <span className='text-[#f56c6c] mb-4 text-[14px]'>{error}</span>}
                    <div className='flex flex-col space-y-[12px]'>
                        ...
                        ><FcGoogle size={16} className='mr-4' />{loadingGoogle ? (
                            <div className='w-5 h-5 mr-4 border-2 border-[#4f46e5] border-t-transparent rounded-full animate-spin' />
                        ) : 'Login with Google'
                            } </button>
                        <button className='flex justify-start items-center space-x-3 rounded-md text-[14px] font-weight-500 py-[12px] px-[20px]
                        text-[#404654] border-[#ebebeb] border-[3px] transition
                        ...
                        ><FontAwesomeIcon icon={faUser} className='mr-4' />{loadingGuest ? (
                    ...
                    <form className="flex flex-col">
                        <div className='flex w-full flex-col mt-3 space-y-[12px]'>
                        ...
                        <span className='text-[13px] text-[#4f46e5] mt-3 mb-6 cursor-pointer text-end w-full'
